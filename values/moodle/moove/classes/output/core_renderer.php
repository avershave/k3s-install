...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function render_login(\core_auth\output\login $form) {
        ...
        if (get_config('theme_moove', 'canloginlocal')) {
            $context->canloginlocal = true;
        }

       // redirects to id server
        if (get_config('theme_moove', 'foundryredirect')) {
            global $SESSION;
            global $CFG;
            ...
            $wantsurl = "%2F";
            $context->foundryurl = $CFG->wwwroot . '/auth/oauth2/login.php?id=' . get_config('theme_moove', 'issuerid') . '&wantsurl=' . $wantsurl . '&sesskey=' . sesskey();
        }

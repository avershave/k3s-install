...
if ($ADMIN->fulltree) {
    ...
    */
    ...
    $setting = new admin_setting_configcheckbox('theme_moove/canloginlocal', get_string('canloginlocal', 'theme_moove'), ini_get_bool('canloginlocal', 'theme_moove'), true);
    $settingpage->add($setting);
    // disable login page
    $setting = new admin_setting_configcheckbox('theme_moove/foundryredirect', get_string('foundryredirect', 'theme_moove'), ini_get_bool('foundryredirect', 'theme_moove'), true);
    $settingpage->add($setting);

    // choose issuer that sends us to identity automatically
    $name = 'theme_moove/issuerid';
    $title = get_string('issuerid', 'theme_moove');
    $description = get_string('issuerid_desc', 'theme_moove');
    $default = '0';
    $options = [];

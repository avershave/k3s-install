...
$string['canloginlocal'] = 'Allow local login';
$string['foundryredirect'] = 'Redirect to foundry';
$string['issuerid'] = 'Identity provider';
$string['issuerid_desc'] = 'This will cause the login page to automatically redirect the user to the identity provider selected';
